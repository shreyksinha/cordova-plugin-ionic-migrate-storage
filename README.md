...
```
cordova plugin add --save @kassamina/cordova-plugin-ionic-migrate-storage@0.3.4
```
...
```
cordova plugin add --save cordova-plugin-ionic-webview@4.1.3 @kassamina/cordova-plugin-ionic-migrate-storage@0.3.4
```
